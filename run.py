...
def setup_argument_parser() -> argparse.ArgumentParser:
    ...
    update_parser.add_argument('--owned-only', default=None, action='store_true', help='Only include repositories owned by the user')
    update_parser.add_argument('--member-only', default=None, action='store_true', help='Only include repositories where user is a member')
    update_parser.add_argument('--include-archived', default=None, action='store_true', help='Include archived repositories')
    update_parser.add_argument('--exclude-forks', default=None, action='store_true', help='Exclude forked repositories')
    ...
    update_parser.add_argument('--allow-downgrade', default=None, action='store_true', help='Allow downgrading package versions')
    ...
    update_parser.add_argument('--use-local-clone', default=None, action='store_true', help='Clone repository locally for modifications (legacy mode)')
    ...
    update_parser.add_argument('--strict-migration-mode', default=None, action='store_true', help='Rollback everything if migrations fail')
    ...
    status_parser.add_argument('--report-only', default=None, action='store_true', help='Only generate report without updating status')
